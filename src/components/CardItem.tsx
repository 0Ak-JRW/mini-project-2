        ...
        return (
          ...
          `}
            ...
            <div className="p-5">
              ...
              <p
                className="text-gray-300 text-sm mb-4 line-clamp-3 min-h-[4rem] overflow-y-auto"
                dangerouslySetInnerHTML={{
                  __html: DOMPurify.sanitize(
                    item.msg
                      ?.replace(/\r?\n/g, "")
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  ...
                  <p className={`text-sm font-semibold pt-2 ${item?.amount > 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {item?.amount > 0 ? `✓ In Stock: ${item?.amount} available` : '✗ Out of Stock'}
                </p>
                </div>
